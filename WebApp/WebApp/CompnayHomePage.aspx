...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server" Visible="true">
    <asp:FormView ID="FormView2" runat="server" CellPadding="4" ForeColor="#333333" Visible="true" DataSourceID="SqlDataSource1" >
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="Both" Width="700px" AutoGenerateColumns="False" DataKeyNames="ID" >
